  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Natural SEO + AEO supporting content */}
        <p className="mx-auto mt-5 max-w-3xl text-sm leading-7 text-slate-400 sm:text-base md:text-lg"></p>
      </motion.header>
      ...
      >
        <p className="text-sm leading-7 text-slate-500 sm:text-base">
          Whether you need a new business website, search engine optimization,
          paid advertising, social media support, content creation, or ongoing
          website maintenance, WebXArtist offers services designed around your
